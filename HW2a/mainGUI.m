...
%% Initializing some global variables and flags
    ...
    mainFig             = figure(   'Visible',              'off', ...
                                    'MenuBar',              'none', ...
                                    'NumberTitle',          'off', ...
                                    'Name',                 'Robot Modeling Tool GUI v2a', ...
                                    'Resize',               'on', ...
...
%% resizeFunc
    function resizeFunc(~,~)
        ...
        p3T1 = b2V-(pad1+pad2+h1+h2+13);% Panel 3 from top 1 [b2V-93]
        ...
        pTR  = 2*(pad1+2)+27;           % prisText from rigth [51]
        rTR  = pTR+15+5;               	% revText from rigth [71]
        qTR  = rTR+25+11;              	% q_iText from rigth [107]
        q2R  = 2*(pad1+2)+27+3;           % q2Radio from rigth [54]
        ...
        panel(4).Position           = [pad1+1              	b4                  fP(3)/2-23     	h4];
        panel(5).Position           = [pad1-13+fP(3)/2      b5                  fP(3)/2-5      	h5];
        panel(6).Position           = [pad3+1             	b6                  fP(3)-2*pad3	h6];
        ...
        DHParaBG.Position           = [pad1                 2                   240             23];
        DHText.Position             = [0                    4                   DHW             tH];
        DHParaR1.Position           = [DP1                  3                   DPW             20];
        DHParaR2.Position           = [DP2                  3                   DPW             20];
        symCheckbox.Position        = [fP(3)-sCR            3                   70              22];
...
%% TransButtonCallback
    function TransButtonCallback(~,~)
        ...
        T0_i = Transformation(d,d_plus,theta,theta_plus,a,alpha,MDH_val);
