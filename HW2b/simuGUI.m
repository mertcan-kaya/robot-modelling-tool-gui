...
%% Initializing some global variables and flags
    ...
    mainFig             = figure(   'Visible',              'off', ...
                                    'MenuBar',              'none', ...
                                    'NumberTitle',          'off', ...
                                    'Name',                 'Robot Modeling Tool GUI v2', ...
                                    'Resize',               'on', ...
    ...
    panel_invisible   	= uipanel(  'Visible',              'off', ...
                                    'Parent',               mainFig, ...
                                    'BorderType',           'none', ...
                                    'Units',                'pixels');
    ...
    tgroup_invisible = uitabgroup('Parent', panel_invisible);
    ...
    tab4 = uitab('Parent', tgroup, 'Title', 'Dynamics');
    ...
    panelTab4(1)     	= uipanel(  'Visible',              'off', ...
                                    'Parent',               tab4, ...
                                    'BorderType',           'none', ...
                                    'Units',                'pixels');
                                
    panelTab4(2)     	= uipanel(  'Visible',              'off', ...
                                    'Parent',               tab4, ...
                                    'BorderType',           'none', ...
                                    'Units',                'pixels');
                                
    panelTab4(3)     	= uipanel(  'Visible',              'off', ...
                                    'Parent',               tab4, ...
                                    'BorderType',           'none', ...
                                    'Units',                'pixels');
                                
    panelTab4(4)     	= uipanel(  'Visible',              'off', ...
                                    'Parent',               tab4, ...
                                    'BorderType',           'none', ...
                                    'Units',                'pixels');
    ...
    panel(3)            = uipanel(  'Visible',              'off', ...
                                    ...
                                    'BorderType',           'etchedin', ...
                                    'Units',                'pixels', ...
                                    'Title',                'Kinematics (Command Window)');
                                
    panel(4)            = uipanel(  'Visible',              'off', ...
                                    'Parent',               mainFig, ...
                                    'BorderType',           'etchedin', ...
                                    'Units',                'pixels', ...
                                    'Title',                'Dynamics (Simulink)');
    ...
    simTimeText         = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(1), ...
                                    'String',               'Simulation Time [sec]:', ...
                                    'HorizontalAlignment',	'left');

    t_0Text             = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(1), ...
                                    'String',               'Start:', ...
                                    'HorizontalAlignment',	'right');

    t_0Edit             = uicontrol('Style',               	'edit', ...
                                    'Parent',             	panelTab4(1), ...
                                    'String',             	t_0, ...
                                    'Callback',           	@t_0EditCallback, ...
                                    'Enable',               'on');
        
    t_stpText        	= uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(1), ...
                                    'String',               'Step:', ...
                                    'HorizontalAlignment',	'right');

    t_stpEdit       	= uicontrol('Style',                'edit', ...
                                    'Parent',             	panelTab4(1), ...
                                    'String',             	t_stp, ...
                                    'Callback',           	@t_stpEditCallback, ...
                                    'Enable',               'on');
        
    t_endText           = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(1), ...
                                    'String',               'End:', ...
                                    'HorizontalAlignment',	'right');

    t_endEdit        	= uicontrol('Style',               	'edit', ...
                                    'Parent',             	panelTab4(1), ...
                                    'String',             	t_end, ...
                                    'Callback',           	@t_endEditCallback, ...
                                    'Enable',               'on');
        
    inputMotText      	= uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(2), ...
                                    'String',               'Input Motion:', ...
                                    'HorizontalAlignment',	'left');

    q_ddText          	= uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(2), ...
                                    'String',               'q_dd:', ...
                                    'HorizontalAlignment',	'right');

    q_ddEdit          	= uicontrol('Style',               	'edit', ...
                                    'Parent',             	panelTab4(2), ...
                                    'String',             	'sin(t)', ...
                                    'Callback',           	@q_ddEditCallback, ...
                                    'Enable',               'off');
        
    q_dText             = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(2), ...
                                    'String',               'q_d:', ...
                                    'HorizontalAlignment',	'right');

    q_dEdit             = uicontrol('Style',                'edit', ...
                                    'Parent',             	panelTab4(2), ...
                                    'String',             	'-cos(t)', ...
                                    'Callback',           	@q_dEditCallback, ...
                                    'Enable',               'off');
        
    q_dynText           = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(2), ...
                                    'String',               'q:', ...
                                    'HorizontalAlignment',	'right');

    q_dynEdit        	= uicontrol('Style',               	'edit', ...
                                    'Parent',             	panelTab4(2), ...
                                    'String',             	'-sin(t)', ...
                                    'Callback',           	@q_dynEditCallback, ...
                                    'Enable',               'off');
        
    invDynText          = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(3), ...
                                    'String',               'Inverse Dynamics:', ...
                                    'HorizontalAlignment',	'left');

    ELinvButton     	= uicontrol('Style',              	'pushbutton', ...
                                    'Parent',             	panelTab4(3), ...
                                    'String',             	'Euler-Lagrange', ...
                                    'Callback',           	@(h,e)(cellfun(@(x)feval(x,h,e), ...
                                                            {@(h,e)ELinvButtonCallback(h), ...
                                                            @(h,e)ELinvButtonPrintCallback(h)})), ...
                                    'TooltipString',       	'Computes required torque via Euler-Lagrange', ...
                                    'Enable',             	'on');
    
    NEinvButton      	= uicontrol('Style',                'pushbutton', ...
                                    'Parent',              	panelTab4(3), ...
                                    'String',              	'Newton-Euler', ...
                                    'Callback',           	@(h,e)(cellfun(@(x)feval(x,h,e), ...
                                                            {@(h,e)NEinvButtonCallback(h), ...
                                                            @(h,e)NEinvButtonPrintCallback(h)})), ...
                                    'TooltipString',       	'Computes required torque via Newton-Euler', ...
                                    'Enable',               'on');
    
    fwdDynText          = uicontrol('Style',                'text', ...
                                    'Parent',               panelTab4(4), ...
                                    'String',               'Forward Dynamics:', ...
                                    'HorizontalAlignment',	'left');

    ELfwdButton     	= uicontrol('Style',              	'pushbutton', ...
                                    'Parent',             	panelTab4(4), ...
                                    'String',             	'Euler-Lagrange', ...
                                    'Callback',           	@(h,e)(cellfun(@(x)feval(x,h,e), ...
                                                            {@(h,e)ELfwdButtonCallback(h), ...
                                                            @(h,e)ELfwdButtonPrintCallback(h)})), ...
                                    'TooltipString',       	'Computes desired trajectory via Euler-Lagrange', ...
                                    'Enable',             	'on');
    
    NEfwdButton      	= uicontrol('Style',                'pushbutton', ...
                                    'Parent',              	panelTab4(4), ...
                                    'String',              	'Newton-Euler', ...
                                    'Callback',           	@(h,e)(cellfun(@(x)feval(x,h,e), ...
                                                            {@(h,e)NEfwdButtonCallback(h), ...
                                                            @(h,e)NEfwdButtonPrintCallback(h)})), ...
                                    'TooltipString',       	'Computes desired trajectory via Newton-Euler', ...
                                    'Enable',               'on');
    ...
    ELButton            = uicontrol('Style',              	'pushbutton', ...
                                    ...
                                    'TooltipString',       	'Opens Euler-Lagrange Simulink file', ...
                                    'Enable',             	'on');
    ...
    NEButton            = uicontrol('Style',                'pushbutton', ...
                                    ...
                                    'TooltipString',       	'Opens Newton-Euler Simulink file', ...
                                    'Enable',               'on');
    ...
    panelTab4(1).Visible = 'on';
    panelTab4(2).Visible = 'on';
    panelTab4(3).Visible = 'on';
    panelTab4(4).Visible = 'on';
    panel(3).Visible = 'on';
    panel(4).Visible = 'on';
    panel(5).Visible = 'on';
...
%% resizeFunc
    function resizeFunc(~,~)
        ...
        panelTab4(1).Position       = [1                    fP(4)-203           fP(3)-2*pad1-5	31];
        panelTab4(2).Position       = [1                    fP(4)-234           fP(3)-2*pad1-5	31];
        panelTab4(3).Position       = [1                    fP(4)-265           fP(3)-2*pad1-5	31];
        panelTab4(4).Position       = [1                    fP(4)-296           fP(3)-2*pad1-5	31];
        ...
        simTimeText.Position        = [pad1-3             	5                   lNW+25         	tH];
        t_0Text.Position            = [lEL-2+11           	5                   lES+9          	tH];
        t_0Edit.Position            = [lEL-2+45             3                   lES+20         	lES];
        t_stpText.Position         	= [lEL-2+91             5                   lES+9          	tH];
        t_stpEdit.Position         	= [lEL-2+125           	3                   lES+20         	lES];
        t_endText.Position        	= [lEL-2+173            5                   lES+7          	tH];
        t_endEdit.Position        	= [lEL-2+205            3                   lES+20         	lES];
        inputMotText.Position       = [pad1-3             	5                   lNW+25         	tH];
        q_ddText.Position        	= [lEL-2+11           	5                   lES+9          	tH];
        q_ddEdit.Position          	= [lEL-2+45             3                   lES+20         	lES];
        q_dText.Position         	= [lEL-2+91             5                   lES+9          	tH];
        q_dEdit.Position         	= [lEL-2+125           	3                   lES+20         	lES];
        q_dynText.Position        	= [lEL-2+173            5                   lES+7          	tH];
        q_dynEdit.Position        	= [lEL-2+205            3                   lES+20         	lES];
        invDynText.Position         = [pad1-3             	5                   lNW+25         	tH];
        ELinvButton.Position       	= [lEL-2+44             2                   b3_w+7       	b_h];
        NEinvButton.Position       	= [lEL-2+44+b3_w+7+6   	2                   b4_w+2        	b_h];
        fwdDynText.Position         = [pad1-3             	5                   lNW+25         	tH];
        ELfwdButton.Position       	= [lEL-2+44             2                   b3_w+7        	b_h];
        NEfwdButton.Position       	= [lEL-2+44+b3_w+7+6   	2                   b4_w+2       	b_h];
...
%% modelListCallback
    function modelListCallback(~,~)
        ...
        if strcmp(DHParaBG.SelectedObject.Tag,'Std')
            [DH_new,~,~,joint] = DHParameters(modelList.Value,n);
            [m,ri_h_ci,It] = DynParameters(modelList.Value,n);
        else
            [DH_new,~,~,joint] = MDHParameters(modelList.Value,n);
            [m,ri_h_ci,It] = DynParameters(modelList.Value,n);
        end
        ...
        if modelList.Value~=5
            ...
            if modelList.Value == 1 || modelList.Value == 4
                tab2.Parent = tgroup;
                tab3.Parent = tgroup;
                tab4.Parent = tgroup;
            else
                tab2.Parent = tgroup_invisible;
                tab3.Parent = tgroup_invisible;
                tab4.Parent = tgroup_invisible;
            end
        else
...
%% editButtonCallback
    function editButtonCallback(~,~)
        ...
        if editButton.Value==0
            ...
            clearTableButton.Enable = 'off';
            DHTableDisable();
            [DH,~,~,joint] = DHParameters(modelList.Value,n);
            n = length(joint);
            q = zeros(n,1);
            theta = zeros(n,1);
            d = zeros(n,1);
...
%% t_0EditCallback
    function t_0EditCallback(~,~)

        t_string = t_0Edit.String;
        t_trial = str2double(t_string);
        
        if (isnan(t_trial))
            t_0Edit.String = t_0;
        else
            if t_trial<0 || t_trial>t_end
                t_0Edit.String = t_0;
            else
                t_0 = t_trial;
                t_0Edit.String = t_0;
...
%% t_stpEditCallback
    function t_stpEditCallback(~,~)

        t_string = t_stpEdit.String;
        t_trial = str2double(t_string);
        
        if (isnan(t_trial))
            t_stpEdit.String = t_stp;
        else
            if t_trial<0.01 || t_trial>1
                t_stpEdit.String = t_stp;
            else
                t_stp = t_trial;
                t_stpEdit.String = t_stp;
...
%% t_endEditCallback
    function t_endEditCallback(~,~)

        t_string = t_endEdit.String;
        t_trial = str2double(t_string);
        
        if (isnan(t_trial))
            t_endEdit.String = t_end;
        else
            if t_trial<t_0 || t_trial>120
                t_endEdit.String = t_end;
            else
                t_end = t_trial;
                t_endEdit.String = t_end;
...
%% p3ButtonDisable
    function p3ButtonDisable(~,~)
        ...
        ELButton.Enable         = 'off';
        NEButton.Enable         = 'off';
        ELinvButton.Enable    	= 'off';
        NEinvButton.Enable     	= 'off';
...
%% p3ButtonEnable
    function p3ButtonEnable(~,~)
        ...
        ELButton.Enable         = 'on';
        NEButton.Enable         = 'on';
        ELinvButton.Enable    	= 'on';
        NEinvButton.Enable    	= 'on';
...
%% ELButtonCallback
    function ELButtonCallback(~,~)
        ...
        progressText.String = 'Opening Euler-Lagrange Simulink file...';
        drawnow;
        
        open_system('EL_simulink')
...
%% ELButtonPrintCallback
    function ELButtonPrintCallback(~,~)
        ...
        progressText.String = 'Euler-Lagrange Simulink file opened.';
...
%% NEButtonCallback
    function NEButtonCallback(~,~)
        ...
        progressText.String = 'Opening Newton-Euler Simulink file...';
        drawnow;
        
        open_system('NE_simulink_working')
...
%% NEButtonPrintCallback
    function NEButtonPrintCallback(~,~)
        ...
        progressText.String = 'Newton-Euler Simulink file opened.';
        
    end

%% ELinvButtonCallback
    function ELinvButtonCallback(~,~)
      	
        progressText.String = 'Computing Inverse Dynamics via E-L...';
        drawnow;
       	
        t_val = [t_0; t_stp; t_end];
        EL_invdyn_func(modelList.Value,n,t_val);
        
    end

%% ELinvButtonPrintCallback
    function ELinvButtonPrintCallback(~,~)
        
        progressText.String = 'Inverse Dynamics Computed via E-L.';
...
%% NEinvButtonCallback
    function NEinvButtonCallback(~,~)
      	
        progressText.String = 'Computing Inverse Dynamics via N-E...';
        drawnow;
       	
        t_val = [t_0; t_stp; t_end];
        NE_invdyn_func(modelList.Value,n,t_val);
        
    end

%% NEinvButtonPrintCallback
    function NEinvButtonPrintCallback(~,~)
        
        progressText.String = 'Inverse Dynamics Computed via N-E.';
...
%% ELfwdButtonCallback
    function ELfwdButtonCallback(~,~)
      	
        progressText.String = 'Computing Forward Dynamics via E-L...';
        drawnow;
       	
        t_val = [t_0; t_stp; t_end];
        EL_fwddyn_func(modelList.Value,n,t_val);
        
    end

%% ELfwdButtonPrintCallback
    function ELfwdButtonPrintCallback(~,~)
        
        progressText.String = 'Forward Dynamics Computed via E-L.';
...
%% NEfwdButtonCallback
    function NEfwdButtonCallback(~,~)
      	
        progressText.String = 'Computing Forward Dynamics via N-E...';
        drawnow;
       	
        t_val = [t_0; t_stp; t_end];
        NE_fwddyn_func(modelList.Value,n,t_val);
        
    end

%% NEfwdButtonPrintCallback
    function NEfwdButtonPrintCallback(~,~)
        
        progressText.String = 'Forward Dynamics Computed via N-E.';
